...
function checkWhoWon(botsWeapon,playersWeapon){
	...
	// look up which weapon botsweapon is
	var botWeaponRule = weapons[botsWeapon];

	if(botsWeapon == playersWeapon){

			displayCompleteMessage("There was ");
	}else if(botWeaponRule.beats === playersWeapon){
		increaseBotScore();
	}else if(botWeaponRule){

	}
	console.log('-------------------');
	console.log('bot weapon: ' + botsWeapon);
	console.log(botWeaponRule);
